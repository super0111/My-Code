...
const networks = [
  ...
  { symbol: BNBSymbol, networkName: 'BNB Smart Chain' },
  { symbol: EthSymbol, networkName: 'Ethereum' },
]
  ...
  return (
    <Box p={3} display='flex' justifyContent='space-between' alignItems='center' sx={{
      ...
      <Box display='flex' alignItems='center'>
        ...
        <Box mr={4} pr={2} display='flex' justifyContent='space-between' alignItems='center' className='network-dropdown' sx={{
          width: '220px',
