...
import { MiddleItem1 } from "./MiddleItem1"
    ...
    <Box sx={{
      ...
      <Box py={2} px={4} display={'flex'} justifyContent={'space-between'} alignItems={'center'} sx={{
        ...
        <Box display={'flex'} alignItems={'center'}>
          <PlayCircleOutlineIcon sx={{ color: '#9a6aff', marginRight: '5px' }} />
