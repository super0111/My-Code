...
import { MiddleItem3 } from "./MiddleItem3"

export const SliderItem3 = (props) => {
    ...
    <Box sx={{
      ...
      <Box py={2} px={4} display={'flex'} justifyContent={'space-between'} alignItems={'center'} sx={{
        ...
        <Box display={'flex'} alignItems={'center'}>
          <AccessTimeIcon sx={{ color: palette.common.white, marginRight: '5px' }} />
      ...
      <Box p={4}>
        ...
        <MiddleItem3 renderer={renderer} count={count}/>
